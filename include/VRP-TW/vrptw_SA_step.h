...
class VrptwSAStep : public SAStep{
private:
  ...
  StepResult perform2opt(const std::shared_ptr<VrptwIndividualStructured> &individual, const std::shared_ptr<SASchedule> &schedule, const std::shared_ptr<VrptwIndividualStructured> &best_individual);
  StepResult performExchange(const std::shared_ptr<VrptwIndividualStructured> &individual, const std::shared_ptr<SASchedule> &schedule, const std::shared_ptr<VrptwIndividualStructured> &best_individual);
  StepResult performRelocate(const std::shared_ptr<VrptwIndividualStructured> &individual, const std::shared_ptr<SASchedule> &schedule, const std::shared_ptr<VrptwIndividualStructured> &best_individual);
  StepResult performCross(const std::shared_ptr<VrptwIndividualStructured> &individual, const std::shared_ptr<SASchedule> &schedule, const std::shared_ptr<VrptwIndividualStructured> &best_individual);
