...
class CvrpSimulatedAnnealing : public Heuristic{
private:
...
public:
  CvrpSimulatedAnnealing(const std::shared_ptr<RoutingInstance> &instance, const std::shared_ptr<SAStep> &step, const std::shared_ptr<SASchedule> schedule);
