...
void TspSimulatedAnnealing::sendSolution(
...
bool TspSimulatedAnnealing::checkBetterSolution(
    const std::shared_ptr<Solution> &solution) {
...
void TspSimulatedAnnealing::initialize(HeuristicPortfolio *portfolio) {
...
void TspSimulatedAnnealing::run() {
...
void TspSimulatedAnnealing::terminate() {
  terminate_.store(true);
}

void TspSimulatedAnnealing::acceptSolution(std::shared_ptr<Solution> solution) {
